...
const Navbar = (props) => {
    // State variables for user image and search key
    const [userImage, setUserImage] = useState("");
    const [searchKey, setSearchKey] = useState("");

    // Function to handle profile login
    const showProfileLoginHandle = () => {
        ...
        // Check for valid input and set user image based on the name
    ...
    return (
        // Navbar structure using React components and styles
        <nav className="flex px-4 py-2 md:shadow-lg items-center relative w-100">
            ...
            <div style={{ width: "100%" }}>
                {/* Header section with navigation links and user profile */}
                <div className="flex small-gap-0 small-height-50" style={{ height: "100px", width: "100%", gap: "5%", flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                    ...
                    <div className="flex" style={{ alignItems: "center" }}>
                        ...
                        {/* Display user profile image or login prompt */}
                        {userImage ?
                ...
                {/* Navigation links for competitions, results & stats, general info, calendar, bookings, and connect */}
